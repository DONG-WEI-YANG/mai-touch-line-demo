...
// CommonJS build of decode-uri-component 0.5.0. The decoding algorithm is
// from the upstream CVE-2026-45822 fix; only the module export is adapted.
    ...
    while (position < input.length) {
      ...
      if (validSequence) {
        ...
        try {
          ...
          // Structurally valid but semantically invalid UTF-8 stays literal.
        }
      }

...
(async () => {
  ...
  // 三大價值卡
  const vals = [
    { ic: gold.bulb,  t: "建案差異化", s: "智慧建材 × 智慧服務一體成形。預售期即可在接待中心展示語音控制、智慧公設等互動情境，成為銷售亮點。" },
  ...
  const road = [
    { inv: ["品牌化客製・功能開發", "雲端部署(Render/Vercel/LINE)", "接待中心示範組(平板+音箱)"], hi: "預售期銷售現場即展示" },
  ...
  phaseSlide(0, "PHASE 0 · DEVELOPMENT FIRST",
    ...
    "本階段投入（開發為主）", [
      ...
      { st: "CORE", n: "接待中心示範組", s: "平板 ×1 + Google Nest 音箱 ×1 —— 本階段唯一硬體" },
      { st: "OPT",  n: "示範閘道(乾跑)", s: "DRY_RUN 模式或示範機,展示燈光/空調語音互動情境" },
    ], [
      "預售期銷售現場互動展示：語音控制、智慧公設情境",
      "建案官方 LINE 提前開通,經營潛在住戶客群",
      "住戶名冊・戶別・帳務規則預建,交屋流程提前數位化",
      "管理後台先行試營運,物業團隊提早熟悉系統",
      "零重硬體投入 —— 開發、行銷、預售同步推進",
    ],
    "本階段以軟體開發為優先；完成後即具備 Phase 1 起分批導入硬體的完整雲端基礎。");
